...
export function MainLayout() {
  const navItems = [
    ...
    { to: '/perfil', icon: <User className="w-6 h-6" />, label: 'Perfil' },
  ];

  return (
    <div className="min-h-screen bg-[#050505] flex justify-center">
      <div className="flex flex-col w-full max-w-md min-h-screen bg-dark-bg text-text-light relative pb-20 border-x border-dark-border/30 shadow-2xl">
        ...
        {/* Bottom Navigation */}
        <nav className="absolute bottom-0 w-full bg-dark-card border-t border-dark-border py-2 px-4 z-50 rounded-t-2xl shadow-[0_-5px_20px_rgba(0,0,0,0.5)]">
